...
contract('SupplyChainOnline', function(accounts) {
    ...
    console.log("Processor: accounts[1] ", accounts[2])
    console.log("Distributor: accounts[2] ", accounts[3])
    console.log("Retailer: accounts[3] ", accounts[4])
    console.log("Consumer: accounts[4] ", accounts[5])
    ...
    it("Testing smart contract function plantItem() that allows a GROWER to PLANT a crop", async() => {
        ...
        await supplyChain.addGrower(originGrowerID, {from: ownerID})
    ...
    it("Testing smart contract function collectItem() that allows a PROCESSOR to COLLECT a crop", async() => {
        ...
        assert.equal(resultBufferOne[0], sku, 'Error: Invalid item SKU')
        assert.equal(resultBufferOne[1], upc, 'Error: Invalid item UPC')
        assert.equal(resultBufferOne[2], processorID, 'Error: Missing or Invalid ownerID')
        assert.equal(resultBufferOne[3], originGrowerID, 'Error: Missing or Invalid originGrowerID')
        assert.equal(resultBufferOne[4], originFarmName, 'Error: Missing or Invalid originFarmName')
        assert.equal(resultBufferOne[5], originFarmInformation, 'Error: Missing or Invalid originFarmInformation')
        assert.equal(resultBufferOne[6], originFarmLatitude, 'Error: Missing or Invalid originFarmLatitude')
